...
def upload():
    ...
    return render_template("uploaded.html", file_path="img/img_now.jpg", old_path="img/img_old.jpg")
...
@app.route("/blurwithsize", methods=["POST"])
@nocache
def blurwithsize():
    size = int(request.form['size'])
    image_processing.blurwithsize(size)
    return render_template("uploaded.html", file_path="img/img_now.jpg", old_path="img/img_old.jpg")
...
@app.route("/lowpassfilterCustom", methods=["POST"])
@nocache
def lowpassfilterCustom():
    size = int(request.form['size'])
    image_processing.lowPassFilterwithgeneratekernel(size)
    return render_template("uploaded.html", file_path="img/img_now.jpg", old_path="img/img_old.jpg")

@app.route("/highpassfilterCustom", methods=["POST"])
@nocache
def highpassfilterCustom():
    size = int(request.form['size'])
    image_processing.highPassFilterwithgeneratekernel(size)
    return render_template("uploaded.html", file_path="img/img_now.jpg", old_path="img/img_old.jpg")

@app.route("/bandpassfilterCustom", methods=["POST"])
@nocache
def bandpassfilterCustom():
    size = int(request.form['size'])
    image_processing.bandPassFilterwithgeneratekernel(size)
    return render_template("uploaded.html", file_path="img/img_now.jpg", old_path="img/img_old.jpg")
